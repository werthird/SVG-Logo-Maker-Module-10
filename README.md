<header style="height: 100px; background: linear-gradient(to right, #000046, #1CB5E0);"><h1 style="font-size: 65px; text-align: center"><strong>SVG Logo Maker</strong></h1></header>
...
A simple command-line SVG Logo Generator. It allows the user to input their desired abbreviations and color scheme, then it will create a simple svg file. This can be downloaded and displayed as a logo for their webpage or whatever marketing tasks are needed.
